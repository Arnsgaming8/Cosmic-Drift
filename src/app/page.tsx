...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const artifacts: Array<{
      x: number; y: number; radius: number;
      pulse: number; collected: boolean;
    }> = [];
    ...
    function updateShip(dt: number) {
      ...
      if (ship.boosting && ship.thrust > 0) {
        if (Math.random() > 0.7) {
          warpLines.push({
  ...
  return (
    <main style={{ margin: 0, padding: 0, overflow: 'hidden', background: '#030308' }}>
      ...
      <div id="hud" className="hud hud-top-left" style={{
        position: 'fixed',
        zIndex: 20,
        color: '#c8d4e3',
        fontSize: '12px',
        ...
        <div style={{
          ...
          <div style={{ marginBottom: '12px' }}>
            <div style={{ color: '#7b68ee', fontSize: '10px', textTransform: 'uppercase', marginBottom: '2px' }}>Velocity</div>
          ...
          <div style={{ marginBottom: '12px' }}>
            <div style={{ color: '#7b68ee', fontSize: '10px', textTransform: 'uppercase', marginBottom: '2px' }}>Coordinates</div>
          ...
          <div>
            <div style={{ color: '#7b68ee', fontSize: '10px', textTransform: 'uppercase', marginBottom: '2px' }}>Artifacts</div>
